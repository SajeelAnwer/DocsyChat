...
<body style="margin:0;padding:0;background:#f7f8fa;font-family:'Helvetica Neue',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 20px;">
    <tr>
      <td align="center">
        <table width="440" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;border:1px solid rgba(0,0,0,0.10);overflow:hidden;">
          <tr>
            <td style="padding:32px 40px 24px;border-bottom:1px solid rgba(0,0,0,0.06);">
              <table cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td style="padding-left:10px;">
                    <span style="font-size:20px;font-weight:600;color:#111111;font-style:italic;">DocsyChat</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:32px 40px;">
              <p style="margin:0 0 8px;font-size:22px;font-weight:600;color:#111111;line-height:1.3;">
                Hi ${firstName}, reset your password
              </p>
              <p style="margin:0 0 28px;font-size:15px;color:#555555;line-height:1.6;">
                Enter this 6-digit code in DocsyChat to reset your password. It expires in <strong>15 minutes</strong>.
              </p>
              <div style="background:#f7f8fa;border:1.5px solid rgba(121,80,176,0.20);border-radius:12px;padding:24px;text-align:center;margin-bottom:28px;">
                <span style="font-size:42px;font-weight:700;letter-spacing:10px;color:#7950B0;font-family:'Courier New',monospace;">${code}</span>
              </div>
          ...
          <tr>
            <td style="padding:20px 40px;border-top:1px solid rgba(0,0,0,0.06);background:#f7f8fa;">
  ...
  await transporter.sendMail({
    from: `"DocsyChat" <${process.env.EMAIL_FROM}>`,
    to: toEmail,
    subject: `${code} — Reset your DocsyChat password`,
    html
  });
}
